...
Na Figura \ref{fig:comunicacao} é possível observar uma ilustração da sequência de atividades que participarão da geração de gráficos, a partir de filtros escolhidos pelo usuário. A princípio, o usuário entrará na aplicação, escolherá alguns filtros, sendo eles: ano da safra, região, município, produtor, período da amostra, responsável técnico, identificação da unidade de referência, cultivar, seleciona se a soja é bt ou não bt e se possuí ou não resistência a ferrugem. O único filtro obrigatório é o ano da safra. Após as escolhas das opções, uma requisição para "\textit{fake} API"\ será realizada, a requisição retornará os dados no formato JSON e os gráficos e tabelas serão apresentados na tela do usuário. 
...
A Figura \ref{fig:home1_menu} mostra um \textit{wireframe} utilizado para a coleta e validação dos requisitos. Este \textit{wireframe} é um protótipo da tela inicial da aplicação.
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque ac nibh sed felis condimentum vulputate. Vivamus eget massa nulla. Ut vestibulum lobortis turpis ut ornare. Donec condimentum, risus at tincidunt hendrerit, sem risus condimentum ex, ut gravida nisi justo eget ligula. Cras nec lacus laoreet, lobortis sem aliquet, hendrerit ante. Donec non urna enim. Quisque commodo mauris at massa elementum pellentesque. Nullam imperdiet felis ut erat auctor, malesuada rutrum purus molestie. Proin molestie velit a iaculis facilisis. Integer ultrices lorem ut nibh dapibus porta eget a libero. Donec nec ligula id libero rutrum dapibus ac quis neque. Sed fermentum rhoncus faucibus.
...
\begin{figure}[H]
	\caption{Tela Inicial - Modo \textit{Mobile}}
	\centering
	\includegraphics[width=14cm]{figuras/home1_celular_1.png} 
	\label{fig:home1_mobile}
	\fonte{Autoria própria}
\end{figure}

\begin{figure}[H]
	\caption{Tela Inicial - Modo \textit{Mobile} com expansão do menu lateral}
	\centering
	\includegraphics[width=6cm]{figuras/home1_mobile_menu.png} 
	\label{fig:home1_mobile_menu}
	\fonte{Autoria própria}
\end{figure}
