...
\chapter{Proposta}
\label{cap3}
Neste capítulo é descrito como as tecnologias e ferramentas serão utilizadas para o desenvolvimento do website.

\section{Tecnologias e Ferramentas}

No desenvolvimento do painel de indicadores, será utilizada a linguagem de marcação HTML em todas as páginas da aplicação. Ela servirá para especificar o conteúdo das páginas, estruturar o \textit{layout} e informar ao navegador o que é cada informação presente nas \textit{tags}. Além do HTML, o CSS será utilizado para estilizar a apresentação das páginas, organizando a forma como os elementos são dispostos, suas cores, tamanhos e formatos. O \textit{framework} Bootstrap será utilizado para adicionar responsividade à aplicação. Por fim, será utilizada a linguagem de programação Javascript em conjunto com a biblioteca JQuery e D3.js. O JQuery será usado para realizar chamadas Ajax à \sigla{API}{\textit{Application Programming Interface}} \sigla{REST}{\textit{Representation State Transfer}} que contém os dados para a elaboração dos gráficos que serão construídos utilizando a biblioteca D3.js. Os gráficos serão utilizados nas análises que estarão presentes no painel de indicadores. 
...
No desenvolvimento desta proposta serão utilizadas algumas técnicas ágeis mais empregadas em 2016 \cite{stateofagile}.
